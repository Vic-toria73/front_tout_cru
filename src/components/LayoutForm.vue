...
<template>
  <div class="min-h-screen flex flex-col">
    ...
    <main class="flex-1 bg-background-alt rounded-t-3xl pt-10 p-4">
      <div class="w-full max-w-md mx-auto">
        <div class="rounded-3xl overflow-hidden">
          ...
          <div class="pb-8 px-6 text-center">
            ...
            <h1 class="text-text text-xl font-bold mb-3">
              {{ title }}
            </h1>

            <p class="text-text text-sm leading-relaxed text-center">
              {{ description }}
            </p>
          </div>
    ...
    <audio ref="audioElement" :src="soundUrl" preload="auto" />
  </div>
</template>
